// ======================================================================
// Oscilliscope.v generated from TopDesign.cysch
// 11/26/2018 at 14:27
...
module USBFS_v3_10_0 (
	...
	cy_psoc3_pins_v1_10
		#(.id("80d09c32-8db8-454d-94b8-bbe4ba6c4eae/8b77a6c4-10a0-4390-971c-672353e2a49c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("80d09c32-8db8-454d-94b8-bbe4ba6c4eae/618a72fc-5ddd-4df5-958f-a3d55102db42"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module ADC_SAR_v3_0_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("038a9590-423a-4a81-91f6-3e75f9e81331/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=1400000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=1, ADC_Resolution=8, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=6, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_2, CY_INSTANCE_SHORT_NAME=ADC_SAR_2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=ADC_SAR_2, )
module ADC_SAR_v3_0_3 (
	...
	cy_psoc3_pins_v1_10
		#(.id("de77bae7-0689-4a86-a86d-19ccf6609c35/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__probe1_net;
	wire [0:0] tmpFB_0__probe1_net;
	wire [0:0] tmpIO_0__probe1_net;
	wire [0:0] tmpINTERRUPT_0__probe1_net;
	electrical [0:0] tmpSIOVREF__probe1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		probe1
		 (.oe(tmpOE__probe1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__probe1_net[0:0]}),
		  .analog({Net_33}),
		  .io({tmpIO_0__probe1_net[0:0]}),
		  .siovref(tmpSIOVREF__probe1_net),
		  .interrupt({tmpINTERRUPT_0__probe1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__probe1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__probe2_net;
	wire [0:0] tmpFB_0__probe2_net;
	wire [0:0] tmpIO_0__probe2_net;
	wire [0:0] tmpINTERRUPT_0__probe2_net;
	electrical [0:0] tmpSIOVREF__probe2_net;

	cy_psoc3_pins_v1_10
		#(.id("8645c817-fbda-4155-96d3-3b79270f603d"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		probe2
		 (.oe(tmpOE__probe2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__probe2_net[0:0]}),
		  .analog({Net_256}),
		  .io({tmpIO_0__probe2_net[0:0]}),
		  .siovref(tmpSIOVREF__probe2_net),
		  .interrupt({tmpINTERRUPT_0__probe2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__probe2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    // -- AMux potSelect start -- ***
    // -- Mux A --
    
    cy_psoc3_amux_v1_0 potSelect(
        .muxin({
            Net_127,
            Net_126
            }),
    ...
    defparam potSelect.muxin_width = 2;
    defparam potSelect.init_mux_sel = 2'h0;
    defparam potSelect.one_active = 0;
    defparam potSelect.connect_mode = 1;
    
    // -- AMux potSelect end --

	wire [0:0] tmpOE__potChannel1_net;
	wire [0:0] tmpFB_0__potChannel1_net;
	wire [0:0] tmpIO_0__potChannel1_net;
	wire [0:0] tmpINTERRUPT_0__potChannel1_net;
	electrical [0:0] tmpSIOVREF__potChannel1_net;

	cy_psoc3_pins_v1_10
		#(.id("72a703dc-cd27-441f-9a52-7262f4bd86dd"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		potChannel1
		 (.oe(tmpOE__potChannel1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__potChannel1_net[0:0]}),
		  .analog({Net_126}),
		  .io({tmpIO_0__potChannel1_net[0:0]}),
		  .siovref(tmpSIOVREF__potChannel1_net),
		  .interrupt({tmpINTERRUPT_0__potChannel1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__potChannel1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__potChannel2_net;
	wire [0:0] tmpFB_0__potChannel2_net;
	wire [0:0] tmpIO_0__potChannel2_net;
	wire [0:0] tmpINTERRUPT_0__potChannel2_net;
	electrical [0:0] tmpSIOVREF__potChannel2_net;

	cy_psoc3_pins_v1_10
		#(.id("c9a76283-b779-4845-a638-7c4077e70fba"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		potChannel2
		 (.oe(tmpOE__potChannel2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__potChannel2_net[0:0]}),
		  .analog({Net_127}),
		  .io({tmpIO_0__potChannel2_net[0:0]}),
		  .siovref(tmpSIOVREF__potChannel2_net),
		  .interrupt({tmpINTERRUPT_0__potChannel2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__potChannel2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_SAR_v3_0_3 ADC_SAR_2 (
        .vplus(Net_256),
        .vminus(Net_223),
        .soc(1'b0),
        .eoc(Net_225),
