...
extern void potSelect_Set(uint8 channel);
extern void potSelect_Unset(uint8 channel);
/* potSelect__addrTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern uint8 CYXDATA * const CYCODE potSelect__addrTable[4];
/* potSelect__maskTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern const uint8 CYCODE potSelect__maskTable[4];
