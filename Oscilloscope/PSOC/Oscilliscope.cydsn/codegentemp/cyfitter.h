...
#define USBFS_ep_1__INTC_MASK 0x10u
#define USBFS_ep_1__INTC_NUMBER 4u
#define USBFS_ep_1__INTC_PRIOR_NUM 7u
#define USBFS_ep_1__INTC_PRIOR_REG CYREG_NVIC_PRI_4
...
#define USBFS_ep_2__INTC_MASK 0x20u
#define USBFS_ep_2__INTC_NUMBER 5u
#define USBFS_ep_2__INTC_PRIOR_NUM 7u
#define USBFS_ep_2__INTC_PRIOR_REG CYREG_NVIC_PRI_5
...
#define USBFS_ep_3__INTC_MASK 0x40u
#define USBFS_ep_3__INTC_NUMBER 6u
#define USBFS_ep_3__INTC_PRIOR_NUM 7u
#define USBFS_ep_3__INTC_PRIOR_REG CYREG_NVIC_PRI_6
...
#define USBFS_ep_4__INTC_MASK 0x80u
#define USBFS_ep_4__INTC_NUMBER 7u
#define USBFS_ep_4__INTC_PRIOR_NUM 7u
#define USBFS_ep_4__INTC_PRIOR_REG CYREG_NVIC_PRI_7
...
#define USBFS_ep_5__INTC_MASK 0x100u
#define USBFS_ep_5__INTC_NUMBER 8u
#define USBFS_ep_5__INTC_PRIOR_NUM 7u
#define USBFS_ep_5__INTC_PRIOR_REG CYREG_NVIC_PRI_8
...
/* probe1 */
#define probe1__0__INTTYPE CYREG_PICU3_INTTYPE0
#define probe1__0__MASK 0x01u
#define probe1__0__PC CYREG_PRT3_PC0
#define probe1__0__PORT 3u
#define probe1__0__SHIFT 0u
#define probe1__AG CYREG_PRT3_AG
#define probe1__AMUX CYREG_PRT3_AMUX
#define probe1__BIE CYREG_PRT3_BIE
#define probe1__BIT_MASK CYREG_PRT3_BIT_MASK
#define probe1__BYP CYREG_PRT3_BYP
#define probe1__CTL CYREG_PRT3_CTL
#define probe1__DM0 CYREG_PRT3_DM0
#define probe1__DM1 CYREG_PRT3_DM1
#define probe1__DM2 CYREG_PRT3_DM2
#define probe1__DR CYREG_PRT3_DR
#define probe1__INP_DIS CYREG_PRT3_INP_DIS
#define probe1__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU3_BASE
#define probe1__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define probe1__LCD_EN CYREG_PRT3_LCD_EN
#define probe1__MASK 0x01u
#define probe1__PORT 3u
#define probe1__PRT CYREG_PRT3_PRT
#define probe1__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define probe1__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define probe1__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define probe1__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define probe1__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define probe1__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define probe1__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define probe1__PS CYREG_PRT3_PS
#define probe1__SHIFT 0u
#define probe1__SLW CYREG_PRT3_SLW

/* probe2 */
#define probe2__0__INTTYPE CYREG_PICU3_INTTYPE1
#define probe2__0__MASK 0x02u
#define probe2__0__PC CYREG_PRT3_PC1
#define probe2__0__PORT 3u
#define probe2__0__SHIFT 1u
#define probe2__AG CYREG_PRT3_AG
#define probe2__AMUX CYREG_PRT3_AMUX
#define probe2__BIE CYREG_PRT3_BIE
#define probe2__BIT_MASK CYREG_PRT3_BIT_MASK
#define probe2__BYP CYREG_PRT3_BYP
#define probe2__CTL CYREG_PRT3_CTL
#define probe2__DM0 CYREG_PRT3_DM0
#define probe2__DM1 CYREG_PRT3_DM1
#define probe2__DM2 CYREG_PRT3_DM2
#define probe2__DR CYREG_PRT3_DR
#define probe2__INP_DIS CYREG_PRT3_INP_DIS
#define probe2__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU3_BASE
#define probe2__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define probe2__LCD_EN CYREG_PRT3_LCD_EN
#define probe2__MASK 0x02u
#define probe2__PORT 3u
#define probe2__PRT CYREG_PRT3_PRT
#define probe2__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define probe2__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define probe2__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define probe2__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define probe2__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define probe2__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define probe2__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define probe2__PS CYREG_PRT3_PS
#define probe2__SHIFT 1u
#define probe2__SLW CYREG_PRT3_SLW

/* ADCDMA1 */
#define ADCDMA1__DRQ_CTL CYREG_IDMUX_DRQ_CTL0
#define ADCDMA1__DRQ_NUMBER 0u
#define ADCDMA1__NUMBEROF_TDS 0u
#define ADCDMA1__PRIORITY 2u
#define ADCDMA1__TERMIN_EN 0u
#define ADCDMA1__TERMIN_SEL 0u
#define ADCDMA1__TERMOUT0_EN 1u
#define ADCDMA1__TERMOUT0_SEL 0u
#define ADCDMA1__TERMOUT1_EN 0u
#define ADCDMA1__TERMOUT1_SEL 0u

/* ADCDMA2 */
#define ADCDMA2__DRQ_CTL CYREG_IDMUX_DRQ_CTL0
#define ADCDMA2__DRQ_NUMBER 1u
#define ADCDMA2__NUMBEROF_TDS 0u
#define ADCDMA2__PRIORITY 2u
#define ADCDMA2__TERMIN_EN 0u
#define ADCDMA2__TERMIN_SEL 0u
#define ADCDMA2__TERMOUT0_EN 1u
#define ADCDMA2__TERMOUT0_SEL 1u
#define ADCDMA2__TERMOUT1_EN 0u
#define ADCDMA2__TERMOUT1_SEL 0u

/* ADCInt1 */
#define ADCInt1__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define ADCInt1__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define ADCInt1__INTC_MASK 0x01u
#define ADCInt1__INTC_NUMBER 0u
#define ADCInt1__INTC_PRIOR_NUM 7u
#define ADCInt1__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define ADCInt1__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define ADCInt1__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* ADCInt2 */
#define ADCInt2__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define ADCInt2__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define ADCInt2__INTC_MASK 0x02u
#define ADCInt2__INTC_NUMBER 1u
#define ADCInt2__INTC_PRIOR_NUM 7u
#define ADCInt2__INTC_PRIOR_REG CYREG_NVIC_PRI_1
#define ADCInt2__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define ADCInt2__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
...
/* potChannel1 */
#define potChannel1__0__INTTYPE CYREG_PICU2_INTTYPE3
#define potChannel1__0__MASK 0x08u
#define potChannel1__0__PC CYREG_PRT2_PC3
#define potChannel1__0__PORT 2u
#define potChannel1__0__SHIFT 3u
#define potChannel1__AG CYREG_PRT2_AG
#define potChannel1__AMUX CYREG_PRT2_AMUX
#define potChannel1__BIE CYREG_PRT2_BIE
#define potChannel1__BIT_MASK CYREG_PRT2_BIT_MASK
#define potChannel1__BYP CYREG_PRT2_BYP
#define potChannel1__CTL CYREG_PRT2_CTL
#define potChannel1__DM0 CYREG_PRT2_DM0
#define potChannel1__DM1 CYREG_PRT2_DM1
#define potChannel1__DM2 CYREG_PRT2_DM2
#define potChannel1__DR CYREG_PRT2_DR
#define potChannel1__INP_DIS CYREG_PRT2_INP_DIS
#define potChannel1__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define potChannel1__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define potChannel1__LCD_EN CYREG_PRT2_LCD_EN
#define potChannel1__MASK 0x08u
#define potChannel1__PORT 2u
#define potChannel1__PRT CYREG_PRT2_PRT
#define potChannel1__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define potChannel1__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define potChannel1__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define potChannel1__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define potChannel1__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define potChannel1__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define potChannel1__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define potChannel1__PS CYREG_PRT2_PS
#define potChannel1__SHIFT 3u
#define potChannel1__SLW CYREG_PRT2_SLW

/* potChannel2 */
#define potChannel2__0__INTTYPE CYREG_PICU2_INTTYPE6
#define potChannel2__0__MASK 0x40u
#define potChannel2__0__PC CYREG_PRT2_PC6
#define potChannel2__0__PORT 2u
#define potChannel2__0__SHIFT 6u
#define potChannel2__AG CYREG_PRT2_AG
#define potChannel2__AMUX CYREG_PRT2_AMUX
#define potChannel2__BIE CYREG_PRT2_BIE
#define potChannel2__BIT_MASK CYREG_PRT2_BIT_MASK
#define potChannel2__BYP CYREG_PRT2_BYP
#define potChannel2__CTL CYREG_PRT2_CTL
#define potChannel2__DM0 CYREG_PRT2_DM0
#define potChannel2__DM1 CYREG_PRT2_DM1
#define potChannel2__DM2 CYREG_PRT2_DM2
#define potChannel2__DR CYREG_PRT2_DR
#define potChannel2__INP_DIS CYREG_PRT2_INP_DIS
#define potChannel2__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define potChannel2__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define potChannel2__LCD_EN CYREG_PRT2_LCD_EN
#define potChannel2__MASK 0x40u
#define potChannel2__PORT 2u
#define potChannel2__PRT CYREG_PRT2_PRT
#define potChannel2__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define potChannel2__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define potChannel2__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define potChannel2__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define potChannel2__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define potChannel2__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define potChannel2__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define potChannel2__PS CYREG_PRT2_PS
#define potChannel2__SHIFT 6u
#define potChannel2__SLW CYREG_PRT2_SLW

/* Miscellaneous */
#define BCLK__BUS_CLK__HZ 24000000U
#define BCLK__BUS_CLK__KHZ 24000U
#define BCLK__BUS_CLK__MHZ 24U
#define CY_PROJECT_NAME "Oscilliscope"
