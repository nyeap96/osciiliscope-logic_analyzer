...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000160u)

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x4800016Cu)
...
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x48000184u)

/* PHUB_CFGMEM1 Address: CYREG_PHUB_CFGMEM1_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x48000188u)
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE potSelect__addrTable[4] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE potSelect__maskTable[4] = {
	0x08u, 0x08u, 
	0x40u, 0x04u, 
};

/*******************************************************************************
* Function Name: potSelect_Set
********************************************************************************
* Summary:
*  This function is used to set a particular channel as active on the AMux.
*
...
*
*******************************************************************************/
void potSelect_Set(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*potSelect__addrTable[channel] |= potSelect__maskTable[channel];
		channel++;
		*potSelect__addrTable[channel] |= potSelect__maskTable[channel];
	}
}
...
*
*******************************************************************************/
void potSelect_Unset(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*potSelect__addrTable[channel] &= (uint8)~potSelect__maskTable[channel];
		channel++;
		*potSelect__addrTable[channel] &= (uint8)~potSelect__maskTable[channel];
	}
}
